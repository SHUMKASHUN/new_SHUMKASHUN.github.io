let info = {
    name: "SHUM KASHUN",
    logo_name: "KASHUN",
    flat_picture: "./src/assets/photo.png",
    config: {
      use_cookies: true,
      navbar: {
        blur: false
    ...
    description:
      "I am KaShun SHUM, a year-2 MPhil student at The Hong Kong University of Science and Technology (Department of Computer Science and Mathematics), advised by Prof. <a target='_blank' href='https://jxhe.github.io/'>Junxian He</a>. Before that I was advised by Prof. <a target='_blank' href='http://tongzhang-ml.org/'>Tong Zhang</a>.",
    description_further:
